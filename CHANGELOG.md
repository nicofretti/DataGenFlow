...
### Added
- Extensibility system via `dgf` CLI: mount custom `user_blocks/` and `user_templates/` directories to extend DataGenFlow without modifying the core
- Extensions UI page for managing custom blocks and templates

### Fixed
- Modal for editing model/embedding configuration
...
[1.5.0]: https://github.com/nicofretti/DataGenFlow/compare/release-v1.4.0...release-v1.5.0
