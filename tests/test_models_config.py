...
from models import GenerationConfig, Record, RecordStatus, RecordUpdate, SeedInput
...
class TestRecordModel:
    ...
    def test_record_creation_minimal(self):
        ...
        record = Record(
            system="test system", user="test user", assistant="test assistant"
        )
    ...
    def test_record_status_enum(self):
        ...
        for status in RecordStatus:
            record = Record(system="test", user="test", assistant="test", status=status)
...
class TestRecordUpdateModel:
    ...
    def test_record_update_partial(self):
        """Test partial update"""
        update = RecordUpdate(system="new system", status=RecordStatus.ACCEPTED)
...
class TestModelInteractions:
    ...
    def test_record_update_preserves_unchanged(self):
        ...
        update = RecordUpdate(
            assistant="updated assistant", status=RecordStatus.ACCEPTED
        )
